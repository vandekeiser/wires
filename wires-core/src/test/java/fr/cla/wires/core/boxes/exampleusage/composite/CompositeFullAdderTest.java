...
import static fr.cla.wires.core.boxes.exampleusage.composite.CompositeHalfAdderTest.COMPOSITE_HALF_ADDER_LONGEST_PATH;
...
public class CompositeFullAdderTest {
    ...
    //Try it: fails with 5, passes with 6 (tested up to 100_000_000)
